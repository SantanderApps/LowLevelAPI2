...
use Santander\LowLevelAPI\I18n\Language;
...
class Logger {
    ...
    private function __construct() {
        ...
        $this->savePath = App::$api->config->getLogDirectory();
    ...
    public function getLogFile($timestamp) {
        $filename = $this->savePath . DIRECTORY_SEPARATOR . strtr($this->filenameTemplate, array('{date}' => $timestamp));
