...
namespace Santander\LowLevelAPI;

use Santander\LowLevelAPI\Base\Config;
use Santander\LowLevelAPI\Base\Logger;
use Santander\LowLevelAPI\Soap\SoapClient;
use Santander\LowLevelAPI\Soap\SoapHeaders;
use Santander\LowLevelAPI\Soap\Authentication;
use Santander\LowLevelAPI\Soap\IdentificationType;
use Santander\LowLevelAPI\Soap\Identifier;
use Santander\LowLevelAPI\Soap\IdentifierType;
use Santander\LowLevelAPI\Soap\Identifiers;
use Santander\LowLevelAPI\Soap\Login;
use Santander\LowLevelAPI\Soap\TransactionHelper;
use Santander\LowLevelAPI\Soap\AuthorizationType;
use Santander\LowLevelAPI\Soap\Actions\GetTokenRequest;
use Santander\LowLevelAPI\Soap\Actions\GetToken;
use Santander\LowLevelAPI\Soap\Actions\GetResultRequest;
use Santander\LowLevelAPI\Soap\Actions\GetResult;
use Santander\LowLevelAPI\Model\Token;
use Santander\LowLevelAPI\Model\Result;
use Santander\LowLevelAPI\Model\Address;
use Santander\LowLevelAPI\I18n\Message;
use Santander\LowLevelAPI\Soap\Actions\TestConnectionRequest;
use Santander\LowLevelAPI\Soap\Actions\TestConnection;

/**
 * @property \Santander\LowLevelAPI\Base\Config $config
 * @property \Santander\LowLevelAPI\Base\Logger $logger
 * @property array $requirements the requirements for the API to work properly
 */
class App {
    /**
     * @var \Santander\LowLevelAPI\Base\Config 
     */
    protected $config;
    ...
    public static function run(\Santander\LowLevelAPI\Base\APIConnectorInterface $config) {
    ...
    private function __construct(\Santander\LowLevelAPI\Base\Config $config) {
        $this->config = $config;
    }
     ...
     * @param string $token
     * @param string $orderNumber
     * @return \Santander\LowLevelAPI\Model\Result|null
     */
     ...
     * @return \Santander\LowLevelAPI\Model\Token
     */
     ...
     * @param \stdClass $webserviceResponse
     * @return \Santander\LowLevelAPI\Model\Result
     */
     ...
     * @return \Santander\LowLevelAPI\Model\Address
     */
