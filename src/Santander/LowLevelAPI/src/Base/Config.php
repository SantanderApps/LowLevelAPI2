...
namespace Santander\LowLevelAPI\Base;

use Santander\LowLevelAPI\I18n\Market;
use Santander\LowLevelAPI\Soap\Country;
...
class Config {
    ...
    /**
     * 
     * @param \Santander\LowLevelAPI\Base\APIConnectorInterface $config the external/platform connector
     */
    ...
    public function isTestMode() {
        return (bool)$this->_connector->getData(static::CONFIG_KEY_TEST_MODE);
    }
    ...
    public function isSandboxMode() {
        return (bool)$this->_connector->getData(static::CONFIG_KEY_SANDBOX_MODE);
    }
    ...
    public function getStoreId() {
        return $this->_connector->getData(static::CONFIG_KEY_STORE_ID);
    }
    ...
    public function getUsername() {
        return $this->_connector->getData(static::CONFIG_KEY_USERNAME);
    }
    ...
    public function getPassword() {
        return $this->_connector->getData(static::CONFIG_KEY_PASSWORD);
    }
    ...
    public function getCertificate() {
        return $this->_connector->getData(static::CONFIG_KEY_CERTIFICATE);
    }
    ...
    public function getMerchantId() {
        return $this->_connector->getData(static::CONFIG_KEY_MERCHANT_ID);
    }
    ...
    public function getLanguage() {
        return $this->_connector->getData(static::CONFIG_KEY_LANGUAGE);
    }
    
    /**
     * Return the market.
     * The returned value must be an instance of \Santander\LowLevelAPI\I18n\Market.
     * NOT YET IMPLEMENTED!
     * @ignore
     * @return \Santander\LowLevelAPI\I18n\Market
     */
    ...
    public function getPaymentMethod() {
        return $this->_connector->getData(static::CONFIG_KEY_PAYMENT_METHOD);
    }
    ...
    public function getSiteEmailAddress() {
        return $this->_connector->getData(static::CONFIG_KEY_SITE_EMAIL_ADDRESS);
    }
    ...
    public function getSiteName() {
        return $this->_connector->getData(static::CONFIG_KEY_SITE_NAME);
    }
    ...
    public function getPlatformName() {
        return $this->_connector->getData(static::CONFIG_KEY_PLATFORM_NAME);
    }
    ...
    public function getPlatformVersion() {
        return $this->_connector->getData(static::CONFIG_KEY_PLATFORM_VERSION);
    }
    ...
    public function getModuleVersion() {
        return $this->_connector->getData(static::CONFIG_KEY_MODULE_VERSION);
    }
    ...
    public function getModuleInstallationDate() {
        return $this->_connector->getData(static::CONFIG_KEY_MODULE_INSTALLATION_DATE);
    }
    ...
    public function getEnableExtendedLogging() {
        return (bool)$this->_connector->getData(static::CONFIG_KEY_ENABLE_EXTENDED_LOGGING);
    }
    ...
    public function getReturnUrl() {
        return $this->_connector->getData(static::CONFIG_KEY_RETURN_URL);
    }
    ...
    public function getAccessLogExternal() {
        return (bool)$this->_connector->getData(static::CONFIG_KEY_ACCESS_LOG_EXTERNAL);
    }
    ...
    public function getLogDirectory() {
        return $this->_connector->getData(static::CONFIG_KEY_LOG_DIRECTORY);
    }
}
